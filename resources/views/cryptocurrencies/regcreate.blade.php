				 ...
				 <form action="/bitregister" method="POST" class="form-horizontal second-form" role="form">
					     {{ csrf_field() }}
					     	<h6 class="text-center">Cryptocurrency</h6>
								...
								<div class="form-group">
					                <label for="city" class="col-xs-3 col-sm-3 col-md-3 col-lg-3 control-label">City <span class="asterisks">*</span></label>
					                <div class="col-xs-8 col-sm-8 col-md-7 col-lg-6">
										<input type="text" name="city" id="city" class="form-control" required="required" placeholder="Enter City">
									</div>
								</div>
					     		<div class="form-group">
